...
The subsequent Currency Wars-inspired burst pass gives those six stronger 125% basics and explicit skill/ultimate refills. Arunima can spend up to 8 charges for an 800% attack; Hanae's skill restores a net 4; Ivara's ultimate restores 6; Hanae's and Roonie's restore 4. Full current values and safeguards are in the Weaver document. The original 75% basics and +1-cost overcharge above still describe the other prototype kits.
