...
module.exports.CHARS={
  ...
  Wex:    {element:'order', tags:['Tank','Healer'],   dmg:9,  speed:104, shield:34,
           bio:'Tank tech. Patches things before they fail, including people.'},
  Tarn:   {element:'chaos', tags:['Tank','DPS'],dmg:7, speed:82,  hpMul:.80, thorns:4.4, taunt:6,
           needsShield:1,
           bio:'Wears the ship\u2019s old boarding plate. Steps in front of everything '+
               'and lets it hit her.'},
  Ferrule:{element:'growth', tags:['Tank','DPS'],dmg:13,speed:88,  shield:22, shieldOnHit:1,
           bio:'Welder. Throws plating overheal whoever is nearest when she swings.'},
  Ballast:{element:'growth', tags:['Tank'],          dmg:13, speed:74,  hpMul:1.5, taunt:3, lifesteal:.3,
           bio:'Was cargo crew. Absorbs punishment and keeps walking.'},

  // ---- DoT: appliers and the spender they exist for ----
  Ash:    {element:'decay', tags:['DoT'],        dmg:8,  speed:100, appliesDot:1, dotPerHit:2, aoe:1, armorShred:12,
           bio:'Xeno-chemist. Aerosolises samples and lets the wind do the rest.'},
  Cinder: {element:'chaos', tags:['DoT','DPS'],dmg:12,speed:94,appliesDot:1, dotPerHit:3,
           bio:'Reactor tech. Everything she touches keeps burning after she leaves.'},
  Pyre:   {element:'chaos', tags:['DoT'],        dmg:11, speed:92,  detonate:1,
           bio:'Demolitions. Waits for the pile to get big enough, then lights it.'},
  Sump:   {element:'growth', tags:['DoT','Healer'], dmg:9,  speed:98,  appliesDot:1, dotPerHit:1, dotSpread:1, heal:18,
           bio:'Field biologist. Corruption jumps hosts when one dies; she counts on it.'},

  // ---- Speed: turn order as a resource ----
  Vane:   {element:'energy', tags:['Speed','Healer'],  dmg:9,  speed:112, turnBoost:.5,
           bio:'Helm. Reads the flow of a fight and shoves people into it early.'},
  Nettle: {element:'energy', tags:['Speed'],         dmg:8,  speed:120, procOn:'ally', procMax:4, procDmg:.42,
           bio:'Too fast, too eager. Fires whenever anyone else does.'},
  Mote:   {element:'energy', tags:['Speed','Breaker'], dmg:9,  speed:116, aoe:1, armorShred:14,
           bio:'Survey drone pilot. Sweeps the whole line looking for cracks.'},

  // ---- DPS: the payoff for everything else ----
  Corr:   {element:'void', tags:['DPS'],      dmg:25, speed:84,
           bio:'Ship\u2019s gunner. One target. One number.'},
  Bosk:   {element:'decay', tags:['DPS','Tank'],dmg:17,speed:80,  hpMul:1.25,
           bio:'Ex-salvage. Enormous, patient, hits like falling cargo.'},
  Maul:   {element:'decay', tags:['DPS','Breaker'],dmg:20,speed:70, procOn:'break', procMax:1, procDmg:2.2,
           bio:'Waits for something to crack, then puts everything into the gap.'},

  // ---- Breaker: read the enemy, open it up ----
  Quill:  {element:'void', tags:['Breaker','DoT'],dmg:9,  speed:110, marks:3,
           bio:'Xeno-botanist. Tags every specimen before she touches it.'},
  Vitre:  {element:'void', tags:['Breaker','Speed'], dmg:8,  speed:108, marks:2, aoe:1, armorShred:10,
           bio:'Sensor officer. Paints the whole line at once, lightly.'},
  Rime:   {element:'order', tags:['Breaker'],         dmg:9,  speed:98,  aoe:1, armorShred:19,
           bio:'Cryo-analyst. Freezes a shell until it fractures on its own.'},
  Ledger: {element:'order', tags:['Breaker','Speed'], dmg:13, speed:96,  procOn:'mark', procMax:2, procDmg:.8,
           bio:'Ship archivist. Answers every hit on anything Quill has written down.'},

  // ---- Healer: the ones who keep it standing ----
  Fen:    {element:'order', tags:['Healer'],          dmg:6,  speed:106, heal:30,
           bio:'Ship medic. Treats the crew like equipment: patched before it fails.'},
  Mire:   {element:'growth', tags:['Healer','Tank'],   dmg:10, speed:100, heal:24, overheal:1, thorns:.5,
           bio:'Navigator. Calm, unhurried, hits back without seeming to notice.'},
  Halo:   {element:'energy', tags:['Healer','Speed'],  dmg:7,  speed:94,  energyGain:36,
...
module.exports.FOEKIND={
  swarm:   {element:'growth', hp:.55,dmg:.5, armorLayers:1,speed:96,
            note:'numerous and disposable \u2014 the fight where your build just works'},
  bruiser: {element:'decay', hp:1.7, dmg:1.1,armorLayers:2,speed:74,
            note:'slow and heavy \u2014 a mild tax on everyone'},
  armored:  {element:'order', hp:1.15,dmg:.5, armorLayers:7,speed:82, dotTaken:2.1,
            note:'enormous shields, soft underneath, and damage over time walks straight past them'},
  cleanser:{element:'void', hp:1.1, dmg:.8, armorLayers:2,speed:104,cleanse:.45,
            note:'cleanses a share of the DoT you put on it'},
  reflector:{element:'chaos', hp:.95,dmg:.7, armorLayers:2,speed:90, thorns:.34,
            note:'answers each hit with a little of its own \u2014 punishes cascades'},
  // new, written against the new tags
  buffer:  {element:'growth', hp:1.2, dmg:.5, armorLayers:2,speed:88, buffAllyDmg:.14,
            note:'strengthens every other enemy \u2014 punishes a slow clear'},
  guardian: {element:'order', hp:1.3, dmg:.7, armorLayers:3,speed:86, protectAlly:.3,
            note:'shelters the enemy beside it \u2014 the answer to single-target burst'},
  fast:{element:'energy', hp:.8, dmg:.6, armorLayers:1,speed:128,
